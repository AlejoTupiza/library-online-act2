...
public class SearchCriteriaGender<Gender> implements Specification<Gender> {
    ...
    @Override
    public Predicate toPredicate(Root<Gender> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
